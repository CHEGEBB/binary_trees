 ...
 * Description: This function checks if a binary tree is complete. A binary
 * tree is complete if all levels are filled except possibly for the
...
int binary_tree_is_complete(const binary_tree_t *tree)
{
    ...
    /* If either the left or right subtree is not complete, the tree is not complete */
